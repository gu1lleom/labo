...
PARAM  <- list()
PARAM$experimento <- "HT9410-9-50"

PARAM$exp_input  <- "TS9310-9-50"
...
kBO_iteraciones  <- 25  #iteraciones de la Optimizacion Bayesiana
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "HT9410-9-100"

PARAM$exp_input  <- "TS9310-9-100"
# FIN Parametros del script
