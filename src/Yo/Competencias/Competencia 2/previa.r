...
PARAM$trainingstrategy$undersampling  <-  2.0   # un undersampling de 0.1  toma solo el 10% de los CONTINUA
PARAM$trainingstrategy$semilla_azar   <- 363373  #Aqui poner la propia semilla
