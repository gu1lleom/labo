#1FF - 05_025 | F - 05_025 | 3F - 05_025 | FFF - 05_025
...
# MM       MM   OOOOOO   DDDDDD    EEEEEEEE  LLLLLLLL   OOOOOO      1FDj - 05_025
...
PARAM  <- list()
PARAM$experimento <- "FTS9320-1FDj - 05_025"

PARAM$exp_input  <- "FFE9250"

PARAM$future       <- c( 202109 )

PARAM$final_train  <- c(202010, 202011, 202012, 202101, 202102, 202103, 202104,202105, 202107 )


PARAM$train$training     <- c(202008, 202009, 202010, 202011, 202012, 202101, 202102, 202103, 202104 )
...
PARAM$train$semilla_sampling  <- 363373
PARAM$train$semilla_under     <- 102433
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "FHT9420-1FDj - 05_025 - 5_55"

PARAM$exp_input  <- "FTS9320-1FDj - 05_025"
# FIN Parametros del script
...
kBO_iteraciones  <- 55  #iteraciones de la Optimizacion Bayesiana
...
# MM  MMM  MM  OO    OO  DD    DD  EEEE      LL        OO    OO  
# MM   M   MM  OO    OO  DD   DDD  EE        LL        OO    OO  
# MM       MM   OOOOOO   DDDDDD    EEEEEEEE  LLLLLLLL   OOOOOO      Fj - 05_025 
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "FTS9320-Fj - 05_025"

PARAM$exp_input  <- "FFE9250"

PARAM$future       <- c( 202109 )

PARAM$final_train  <- c( 202103, 202104,202105, 202107 )


PARAM$train$training     <- c( 202101, 202102, 202103, 202104)
PARAM$train$validation   <- c( 202105 )
PARAM$train$testing      <- c( 202107 )
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "FHT9420-Fj - 05_025 - 5_55"

PARAM$exp_input  <- "FTS9320-Fj - 05_025"
# FIN Parametros del script
...
# MM  MMM  MM  OO    OO  DD    DD  EEEE      LL        OO    OO  
# MM   M   MM  OO    OO  DD   DDD  EE        LL        OO    OO  
# MM       MM   OOOOOO   DDDDDD    EEEEEEEE  LLLLLLLL   OOOOOO      3Fj - 05_025
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "FTS9320-3Fj - 05_025"

PARAM$exp_input  <- "FFE9250"

PARAM$future       <- c( 202109 )

PARAM$final_train  <- c(  202101, 202102, 202103, 202104,202105, 202107 )


PARAM$train$training     <- c( 202011, 202012, 202101, 202102, 202103, 202104 )
PARAM$train$validation   <- c( 202105 )
PARAM$train$testing      <- c( 202107 )
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "FHT9420-3Fj - 05_025 - 5_55"

PARAM$exp_input  <- "FTS9320-3Fj - 05_025"
# FIN Parametros del script
...
# MM  MMM  MM  OO    OO  DD    DD  EEEE      LL        OO    OO  
# MM   M   MM  OO    OO  DD   DDD  EE        LL        OO    OO  
# MM       MM   OOOOOO   DDDDDD    EEEEEEEE  LLLLLLLL   OOOOOO      FFFj - 05_025
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "FTS9320-FFFj - 05_025"

PARAM$exp_input  <- "FFE9250"

PARAM$future       <- c( 202109 )

PARAM$final_train  <- c(202007, 202008, 20209, 202010, 202011, 202012, 202101, 202102, 202103, 202104,202105,  202107 )


PARAM$train$training     <- c( 202005, 202006, 202007, 202008, 202009, 202010, 202011, 202012, 202101, 202102, 202103, 202104 )
PARAM$train$validation   <- c( 202105 )
PARAM$train$testing      <- c( 202107 )
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "FHT9420-FFFj - 05_025 - 5_30"

PARAM$exp_input  <- "FTS9320-FFFj - 05_025"
# FIN Parametros del script
