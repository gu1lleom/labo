...
# MM       MM   OOOOOO   DDDDDD    EEEEEEEE  LLLLLLLL   OOOOOO      FFFDj - 75_05
...
PARAM  <- list()
PARAM$experimento <- "FTS9320-FFFDj - 75_05"

PARAM$exp_input  <- "FFE9250"

PARAM$future       <- c( 202109 )

PARAM$final_train  <- c( 202004, 202005, 202006, 202007, 202008, 202009, 202010, 202011, 202012, 202101, 202102, 202103, 202104, 202105, 202107 )


PARAM$train$training     <- c( 202002, 202003, 202004, 202005, 202006, 202007, 202008, 202009, 202010, 202011, 202012, 202101, 202102, 202103, 202104 )
PARAM$train$validation   <- c( 202105 )
PARAM$train$testing      <- c( 202107 )

PARAM$train$sampling_total  <- 0.75  # 1.0 significa que NO se hace sampling total,  0.3 es quedarse con el 30% de TODOS los registros
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "FHT9420-FFFDj - 75_05 - 5_65"

PARAM$exp_input  <- "FTS9320-FFFDj - 75_05"
# FIN Parametros del script
...
kBO_iteraciones  <- 65  #iteraciones de la Optimizacion Bayesiana
