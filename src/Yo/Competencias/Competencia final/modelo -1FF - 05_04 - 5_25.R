...
# MM       MM   OOOOOO   DDDDDD    EEEEEEEE  LLLLLLLL   OOOOOO     1FF - 05_04
...
PARAM  <- list()
PARAM$experimento <- "FTS9320-1FF - 05_04"
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "FHT9420-1FF - 05_04 - 5_25"

PARAM$exp_input  <- "FTS9320-1FF - 05_04"
# FIN Parametros del script
