...
# MM       MM   OOOOOO   DDDDDD    EEEEEEEE  LLLLLLLL   OOOOOO      1FFD - 1_1
...
PARAM  <- list()
PARAM$experimento <- "FTS9320-1FFD - 1_1"
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "FHT9420-1FFD - 1_1 - 5_75"

PARAM$exp_input  <- "FTS9320-1FFD - 1_1"
# FIN Parametros del script
