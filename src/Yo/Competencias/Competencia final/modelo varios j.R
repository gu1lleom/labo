...
# MM       MM   OOOOOO   DDDDDD    EEEEEEEE  LLLLLLLL   OOOOOO      1FFFj - 1_04
...
PARAM  <- list()
PARAM$experimento <- "FTS9320-1FFFj - 1_04"

PARAM$exp_input  <- "FFE9250"

PARAM$future       <- c( 202109 )

PARAM$final_train  <- c( 202006,202007, 202008, 202009, 202010, 202011, 202012, 202101, 202102, 202103, 202104 ,202105, 202107 )


PARAM$train$training     <- c( 202004,202005,202006, 202007, 202008, 202009, 202010, 202011, 202012, 202101, 202102, 202103, 202104 )
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "FHT9420-1FFFj - 1_04 - 5_50"

PARAM$exp_input  <- "FTS9320-1FFFj - 1_04"
# FIN Parametros del script
...
# MM  MMM  MM  OO    OO  DD    DD  EEEE      LL        OO    OO  
# MM   M   MM  OO    OO  DD   DDD  EE        LL        OO    OO  
# MM       MM   OOOOOO   DDDDDD    EEEEEEEE  LLLLLLLL   OOOOOO      1FFDj - 1_1
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "FTS9320-1FFDj - 1_1"

PARAM$exp_input  <- "FFE9250"

PARAM$future       <- c( 202109 )

PARAM$final_train  <- c( 202007, 202008, 202009, 202010, 202011, 202012, 202101, 202102, 202103, 202104 ,202105, 202107 )
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "FHT9420-1FFDj - 1_1 - 5_75"

PARAM$exp_input  <- "FTS9320-1FFDj - 1_1"
# FIN Parametros del script
