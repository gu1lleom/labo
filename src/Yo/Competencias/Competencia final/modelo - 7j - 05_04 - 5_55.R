...
# MM       MM   OOOOOO   DDDDDD    EEEEEEEE  LLLLLLLL   OOOOOO      7j - 05_04
...
PARAM  <- list()
PARAM$experimento <- "FTS9320-7j - 05_04"

PARAM$exp_input  <- "FFE9250"

PARAM$future       <- c( 202109 )

PARAM$final_train  <- c( 202104, 202105, 202107 )


PARAM$train$training     <- c( 202102, 202103, 202104 )
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "FHT9420-7j - 05_04 - 5_55"

PARAM$exp_input  <- "FTS9320-7j - 05_04"
# FIN Parametros del script
