...
#     zz       zz
#   zz       zz
# zzzzzzz  zzzzzzz    FFF - 05_025 - 5_30
...
PARAM  <- list()
PARAM$experimento  <- "FZZ9420-FFF - 05_025 - 5_30"
PARAM$exp_input  <- "FHT9420-FFF - 05_025 - 5_30"
...
#     zz       zz
#   zz       zz
# zzzzzzz  zzzzzzz    FFFj - 05_025 - 5_30
...
#Parametros del script
PARAM  <- list()
PARAM$experimento  <- "FZZ9420-FFFj - 05_025 - 5_30"
PARAM$exp_input  <- "FHT9420-FFFj - 05_025 - 5_30"
...
#     zz       zz
#   zz       zz
# zzzzzzz  zzzzzzz    FZZ9420-1DDF - 1_1 - 5_75
...
#Parametros del script
PARAM  <- list()
PARAM$experimento  <- "FZZ9420-1DDF - 1_1 - 5_75"
PARAM$exp_input  <- "FHT9420-1DDF - 1_1 - 5_75"
...
#     zz       zz
#   zz       zz
# zzzzzzz  zzzzzzz    FZZ9420-1FFFj - 1_04 - 5_50
...
#Parametros del script
PARAM  <- list()
PARAM$experimento  <- "FZZ9420-1FFFj - 1_04 - 5_50"
PARAM$exp_input  <- "FHT9420-1FFFj - 1_04 - 5_50"
...
#Parametros del script
PARAM  <- list()
PARAM$experimento  <- "FZZ9420-1FFD - 1_1 - 5_75"
PARAM$exp_input  <- "FHT9420-1FFD - 1_1 - 5_75"
