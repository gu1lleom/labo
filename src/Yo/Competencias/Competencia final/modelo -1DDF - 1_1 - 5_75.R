...
PARAM  <- list()
PARAM$experimento <- "FTS9320-1DDF - 1_1"

PARAM$exp_input  <- "FFE9250"

PARAM$future       <- c( 202109 )

PARAM$final_train  <- c( 202007, 202008, 202009 ,202011, 202012, 202101, 202102, 202103, 202104 ,202105, 202106, 202107 )


PARAM$train$training     <- c( 202005, 202006, 202007, 202008, 202009, 202011, 202012, 202101, 202102, 202103, 202104, 202105 )
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "FHT9420-1DDF - 1_1 - 5_75"

PARAM$exp_input  <- "FTS9320-1DDF - 1_1"
# FIN Parametros del script
