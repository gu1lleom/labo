...
# MM       MM   OOOOOO   DDDDDD    EEEEEEEE  LLLLLLLL   OOOOOO     3F - 05_04 - 5_25
...
PARAM  <- list()
PARAM$experimento <- "FTS9320-3F - 05_04"
...
#  BB  BBB  OO   OO
#  BB  BB   OO   OO
#  BBBBB     OOOOO		3F - 05_04 - 5_55   ojo 25 mal son 55
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "FHT9420-3F - 05_04 - 5_25"

PARAM$exp_input  <- "FTS9320-3F - 05_04"
# FIN Parametros del script
