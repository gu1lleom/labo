...
# MM       MM   OOOOOO   DDDDDD    EEEEEEEE  LLLLLLLL   OOOOOO      1FFE001Dj - 05_05
...
PARAM  <- list()
PARAM$experimento <- "FTS9320-1FFE001Dj - 05_05"

PARAM$exp_input  <- "FFE9250"

PARAM$future       <- c( 202109 )

PARAM$final_train  <- c( 201903, 201904, 201905, 201906, 201907, 201908, 201909, 201910, 201911, 201912, 202001, 202002, 202103, 202104, 202105, 202107 )


PARAM$train$training     <- c( 201901, 201902, 201903, 201904, 201905, 201906, 201907, 201908, 201909, 201910, 201911, 201912, 202001, 202002, 202103, 202104 )
...
#  BB  BBB  OO   OO
#  BB  BB   OO   OO
#  BBBBB     OOOOO    1FFE001Dj - 05_05 - 5_50
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "FHT9420-1FFE001Dj - 05_05 - 5_50"

PARAM$exp_input  <- "FTS9320-1FFE001Dj - 05_05"
# FIN Parametros del script
