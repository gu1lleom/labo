...
# MM       MM   OOOOOO   DDDDDD    EEEEEEEE  LLLLLLLL   OOOOOO      1FF - 05_025
...
PARAM  <- list()
PARAM$experimento <- "FTS9320-1FF - 05_025"
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "FHT9420-1FF - 05_025 - 5_55"

PARAM$exp_input  <- "FTS9320-1FF - 05_025"
# FIN Parametros del script
...
# MM  MMM  MM  OO    OO  DD    DD  EEEE      LL        OO    OO  
# MM   M   MM  OO    OO  DD   DDD  EE        LL        OO    OO  
# MM       MM   OOOOOO   DDDDDD    EEEEEEEE  LLLLLLLL   OOOOOO      F - 05_025 
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "FTS9320-F - 05_025"

PARAM$exp_input  <- "FFE9250"

PARAM$future       <- c( 202109 )

PARAM$final_train  <- c( 202104,202105, 202106, 202107 )


PARAM$train$training     <- c(202102, 202103, 202104, 202105 )
PARAM$train$validation   <- c( 202106 )
PARAM$train$testing      <- c( 202107 )
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "FHT9420-F - 05_025 - 5_55"

PARAM$exp_input  <- "FTS9320-F - 05_025"
# FIN Parametros del script
...
# MM  MMM  MM  OO    OO  DD    DD  EEEE      LL        OO    OO  
# MM   M   MM  OO    OO  DD   DDD  EE        LL        OO    OO  
# MM       MM   OOOOOO   DDDDDD    EEEEEEEE  LLLLLLLL   OOOOOO      3F - 05_025
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "FTS9320-3F - 05_025"

PARAM$exp_input  <- "FFE9250"

PARAM$future       <- c( 202109 )

PARAM$final_train  <- c(202102, 202103, 202104,202105, 202106, 202107 )
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "FHT9420-3F - 05_025 - 5_55"

PARAM$exp_input  <- "FTS9320-3F - 05_025"
# FIN Parametros del script
...
# MM  MMM  MM  OO    OO  DD    DD  EEEE      LL        OO    OO  
# MM   M   MM  OO    OO  DD   DDD  EE        LL        OO    OO  
# MM       MM   OOOOOO   DDDDDD    EEEEEEEE  LLLLLLLL   OOOOOO      FFF - 05_025
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "FTS9320-FFF - 05_025"

PARAM$exp_input  <- "FFE9250"

PARAM$future       <- c( 202109 )

PARAM$final_train  <- c(202008, 20209, 202010, 202011, 202012, 202101, 202102, 202103, 202104,202105, 202106, 202107 )
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "FHT9420-FFF - 05_025 - 5_30"

PARAM$exp_input  <- "FTS9320-FFF - 05_025"
# FIN Parametros del script
